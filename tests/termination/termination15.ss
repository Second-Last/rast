...
proc Buildn= caseL( mu_nodeinfo=> caseL( zero=> R.mu_nodeinfo;R.node; Build
                                         | one=> R.mu_nodeinfo;R.node; Build
                                         | node=> L.nu_tree; L.left; R.mu_nodeinfo;R.node; Build))
...
proc treetonat= L.nu_tree;L.left;Extract