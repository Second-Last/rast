...
type bits1 = +{b0 : |>bits1, b1 : |>bits1, $ : |{2}> 1}
...
proc copy = caseL ( b0 => getL ; R.b0 ; copy
                  | b1 => getL ; R.b1 ; copy
                  | $  => getL {2} ; R.$ ; waitL ; closeR )

proc plus1 : bits1 |{1}- bits0

proc plus1 = caseL ( b0 => getL ; R.b1 ; work ; copy
                   | b1 => getL ; R.b0 ; plus1
                   | $  => getL {2} ; R.b1 ; R.$ ; waitL ; closeR )

proc zero : . |{4}- bits1

proc zero = R.$ ; payR {2} ; closeR
...
proc x = R.b1 ; payR ; R.b0 ; payR ; R.b1 ; payR ; R.b1 ; payR ; R.b1 ; payR ; 
         R.b0 ; payR ; R.b1 ; payR ; R.b1 ; payR ; R.$ ; payR {2} ; closeR
...
type pbits1 = +{b0 : |>pbits1, b1 : |> fbits1, $ : |{2}> 1}
type fbits1 = +{b0 : |> pbits1, b1 : fbits1, $ : |{2}> 1}
...
proc fx = R.b1 ; payR ; R.b0 ; payR ; R.b1 ; payR ; R.b1 ; R.b1 ; 
         R.b0 ; payR ; R.b1 ; payR ; R.b1 ; R.$ ; payR {2} ; closeR
