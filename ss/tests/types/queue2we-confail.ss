...
proc bit0{n} = caseR ( enq => caseR ( b0 => getR{2*n} ; L.enq ; L.b0 ; payL{2*n} ; bit0{n+1}
                                    | b1 => getR{2*n} ; L.enq ; L.b1 ; payL{2*n} ; bit0{n+1} )
                     | deq => getR{2} ; R.some ; assertR {n > 0} ; R.b0 ; <-> )
proc bit1{n} = caseR ( enq => caseR ( b0 => getR{2*n} ; L.enq ; L.b0 ; payL{2*n} ; bit1{n+1}
                                    | b1 => getR{2*n} ; L.enq ; L.b1 ; payL{2*n} ; bit1{n+1} )
