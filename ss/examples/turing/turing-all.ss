...
% terminates, but doesn't check
% see TuringUnary for better version
...
proc Reset= caseR (nu_epat => caseR (eone=> (R.mu_tape;R.tone; <->) [tape] Reset
                                     |estar=> (R.mu_tape;R.tstar; <->) [tape] Reset
                                     |emiddle=> (R.mu_tape;R.tmiddle; <->) [tape] Reset
                                     |eend=>   <->))
