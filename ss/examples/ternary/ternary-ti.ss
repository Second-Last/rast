...
proc copy : ternary |- ()ternary
proc copy = caseL ( m1 => R.m1 ; copy
                  | z0 => R.z0 ; copy
                  | p1 => R.p1 ; copy
                  | e => R.e ; waitL ; closeR )

proc inc : ternary |- ()ternary
proc inc = caseL ( m1 => R.z0 ; copy
                 | z0 => R.p1 ; copy
                 | p1 => R.m1 ; inc
                 | e => R.p1 ; waitL ; R.e ; closeR )

proc dec : ternary |- ()ternary
proc dec = caseL ( m1 => R.p1 ; dec
                 | z0 => R.m1 ; copy
                 | p1 => R.z0 ; copy
                 | e => R.m1 ; waitL ; R.e ; closeR )

(* With present reconstruction, the remaining is hard
 * to achieve with implicit syntax.
 * See files ternary-te.ss and ternary-te-bdd.ss
 *)
