...
% after reconstruction with cost model --work=none --time=recv
proc copy2{r} = copy{r} || delay ; copy{r}
 ...
 *)
% this fails the termination checker
...
(* omitted the section on base10 representation *)
